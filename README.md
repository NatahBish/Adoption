...
Copy the code from GitHub (green button in the top right and use the Adoption.zip file, either give that to Nexus (untested) or just unzip and put it in your Bannerlord modules folder.
